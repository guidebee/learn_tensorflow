...
def print_play(textStr, line, background):
    ...
    for text in textStr:
        ...
        offset = (94 * (area - 1) + (index - 1)) * FONT_SIZE * 2
    ...
    for row in rect_list:
        ...
        y += 1
    #
    # for x in range(total_x//2):
    #     print(f'{{x:{x*2},y:0}},', end='')
    #
    # for x in range(total_x//2):
    #     print(f'{{x:{x*2+1},y:1}},', end='')
...
backgroundSign = '○'
# backgroundSign = "."
print_play(inpt, lineSign, backgroundSign)
